#!/usr/bin/env bash
# @description Emit rc integration (mise/brew activation, shortcut shims on PATH)
# @usage eval "$(tiss init)"
# @example eval "$(tiss init)"   # in ~/.zshrc or ~/.bashrc
#
...
#      names from `tiss shortcuts` win everywhere (the dispatcher
